class tarjeta
{
	public:
		...
		virtual double calculaPago(Reloj horaEntrada, Reloj horaSalida, int tarifa) = 0;
...
{
	Reloj rNuevo;
	rNuevo.setMinu((horaSalida.getHora()*60 + horaSalida.getMinu()) - (horaEntrada.getHora()*60 + horaEntrada.getMinu()));
